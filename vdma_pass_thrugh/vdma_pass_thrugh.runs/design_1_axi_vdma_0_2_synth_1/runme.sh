...
HD_PWD='C:/work/zynq/hls/base_projects/vdma_pass_thrugh/vdma_pass_thrugh.runs/design_1_axi_vdma_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_vdma_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_vdma_0_2.tcl
