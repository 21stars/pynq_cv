...
// ==============================================================
#ifndef __sobel_accel_mac_mpcA__HH__
#define __sobel_accel_mac_mpcA__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_accel_mac_mpcA) {
    ...
    SC_CTOR(sobel_accel_mac_mpcA):  simcore_mac_4_U ("simcore_mac_4_U") {
