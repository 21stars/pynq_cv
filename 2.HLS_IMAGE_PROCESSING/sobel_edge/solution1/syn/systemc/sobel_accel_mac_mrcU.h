...
// ==============================================================
#ifndef __sobel_accel_mac_mrcU__HH__
#define __sobel_accel_mac_mrcU__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_accel_mac_mrcU) {
    ...
    SC_CTOR(sobel_accel_mac_mrcU):  simcore_mac_6_U ("simcore_mac_6_U") {
