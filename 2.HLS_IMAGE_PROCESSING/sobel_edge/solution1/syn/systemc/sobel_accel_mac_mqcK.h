...
// ==============================================================
#ifndef __sobel_accel_mac_mqcK__HH__
#define __sobel_accel_mac_mqcK__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_accel_mac_mqcK) {
    ...
    SC_CTOR(sobel_accel_mac_mqcK):  simcore_mac_5_U ("simcore_mac_5_U") {
