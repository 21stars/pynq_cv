...
// ==============================================================
#ifndef __sobel_accel_mac_mbkb__HH__
#define __sobel_accel_mac_mbkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_accel_mac_mbkb) {
    ...
    SC_CTOR(sobel_accel_mac_mbkb):  simcore_mac_0_U ("simcore_mac_0_U") {
