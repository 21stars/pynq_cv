...
// ==============================================================
#ifndef __sobel_accel_mac_msc4__HH__
#define __sobel_accel_mac_msc4__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_accel_mac_msc4) {
    ...
    SC_CTOR(sobel_accel_mac_msc4):  simcore_mac_7_U ("simcore_mac_7_U") {
