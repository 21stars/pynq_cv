...
// ==============================================================
#ifndef __sobel_accel_mul_mjbC__HH__
#define __sobel_accel_mul_mjbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_accel_mul_mjbC) {
    ...
    SC_CTOR(sobel_accel_mul_mjbC):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
