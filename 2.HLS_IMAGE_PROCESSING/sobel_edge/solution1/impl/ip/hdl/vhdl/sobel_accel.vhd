...
architecture behav of sobel_accel is 
    ...
    "sobel_accel,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu3eg-sbva484-1-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=8.543647,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=9,HLS_SYN_DSP=43,HLS_SYN_FF=5255,HLS_SYN_LUT=13546,HLS_VERSION=2019_1}";
    ...
    signal ConvertScaleAbs273_U0_ap_start : STD_LOGIC;
    signal ConvertScaleAbs273_U0_ap_done : STD_LOGIC;
    signal ConvertScaleAbs273_U0_ap_continue : STD_LOGIC;
    signal ConvertScaleAbs273_U0_ap_idle : STD_LOGIC;
    signal ConvertScaleAbs273_U0_ap_ready : STD_LOGIC;
    signal ConvertScaleAbs273_U0_p_src_data_stream_V_read : STD_LOGIC;
    signal ConvertScaleAbs273_U0_p_dst_data_stream_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal ConvertScaleAbs273_U0_p_dst_data_stream_V_write : STD_LOGIC;
    signal ConvertScaleAbs_U0_ap_start : STD_LOGIC;
    signal ConvertScaleAbs_U0_ap_done : STD_LOGIC;
    signal ConvertScaleAbs_U0_ap_continue : STD_LOGIC;
    signal ConvertScaleAbs_U0_ap_idle : STD_LOGIC;
    signal ConvertScaleAbs_U0_ap_ready : STD_LOGIC;
    signal ConvertScaleAbs_U0_p_src_data_stream_V_read : STD_LOGIC;
    signal ConvertScaleAbs_U0_p_dst_data_stream_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal ConvertScaleAbs_U0_p_dst_data_stream_V_write : STD_LOGIC;
    ...
    signal src_rows_V_c26_full_n : STD_LOGIC;
    signal src_rows_V_c26_dout : STD_LOGIC_VECTOR (11 downto 0);
    signal src_rows_V_c26_empty_n : STD_LOGIC;
    signal src_cols_V_c27_full_n : STD_LOGIC;
    signal src_cols_V_c27_dout : STD_LOGIC_VECTOR (11 downto 0);
    signal src_cols_V_c27_empty_n : STD_LOGIC;
    ...
    signal sobel_x64_data_strea_full_n : STD_LOGIC;
    signal sobel_x64_data_strea_dout : STD_LOGIC_VECTOR (15 downto 0);
    signal sobel_x64_data_strea_empty_n : STD_LOGIC;
    signal sobel_y64_data_strea_full_n : STD_LOGIC;
    signal sobel_y64_data_strea_dout : STD_LOGIC_VECTOR (15 downto 0);
    signal sobel_y64_data_strea_empty_n : STD_LOGIC;
    ...
    signal sobel_g_rows_V_c28_full_n : STD_LOGIC;
    signal sobel_g_rows_V_c28_dout : STD_LOGIC_VECTOR (11 downto 0);
    signal sobel_g_rows_V_c28_empty_n : STD_LOGIC;
    signal sobel_g_cols_V_c29_full_n : STD_LOGIC;
    signal sobel_g_cols_V_c29_dout : STD_LOGIC_VECTOR (11 downto 0);
    signal sobel_g_cols_V_c29_empty_n : STD_LOGIC;
    ...
    signal start_for_ConvertScaleAbs273_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_ConvertScaleAbs273_U0_full_n : STD_LOGIC;
    signal start_for_ConvertScaleAbs273_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_ConvertScaleAbs273_U0_empty_n : STD_LOGIC;
    signal start_for_ConvertScaleAbs_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_ConvertScaleAbs_U0_full_n : STD_LOGIC;
    signal start_for_ConvertScaleAbs_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_ConvertScaleAbs_U0_empty_n : STD_LOGIC;
    signal ConvertScaleAbs273_U0_start_full_n : STD_LOGIC;
    signal ConvertScaleAbs273_U0_start_write : STD_LOGIC;
    signal ConvertScaleAbs_U0_start_full_n : STD_LOGIC;
    signal ConvertScaleAbs_U0_start_write : STD_LOGIC;
    ...
    component ConvertScaleAbs273 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component start_for_AddWeigxdS IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_Sobel_1Bew IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_ConvertCeG IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_ConvertDeQ IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_CvtColoEe0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_Mat2AXIFfa IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    ConvertScaleAbs273_U0 : component ConvertScaleAbs273
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    ConvertScaleAbs_U0 : component ConvertScaleAbs
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    sobel_g_rows_V_c_U : component fifo_w12_d8_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    sobel_g_cols_V_c_U : component fifo_w12_d8_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    src_rows_V_c26_U : component fifo_w12_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    src_cols_V_c27_U : component fifo_w12_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    sobel_x64_data_strea_U : component fifo_w16_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    sobel_y64_data_strea_U : component fifo_w16_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    sobel_g_rows_V_c28_U : component fifo_w12_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    sobel_g_cols_V_c29_U : component fifo_w12_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_AddWeigxdS_U : component start_for_AddWeigxdS
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Sobel_1Bew_U : component start_for_Sobel_1Bew
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_ConvertCeG_U : component start_for_ConvertCeG
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_ConvertDeQ_U : component start_for_ConvertDeQ
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_CvtColoEe0_U : component start_for_CvtColoEe0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Mat2AXIFfa_U : component start_for_Mat2AXIFfa
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ConvertScaleAbs273_U0_ap_start <= start_for_ConvertScaleAbs273_U0_empty_n;
    ...
    ConvertScaleAbs_U0_ap_start <= start_for_ConvertScaleAbs_U0_empty_n;
    ...
    ap_done <= Mat2AXIvideo_U0_ap_done;
    ap_idle <= (Sobel_U0_ap_idle and Sobel_1_U0_ap_idle and Mat2AXIvideo_U0_ap_idle and GaussianBlur_U0_ap_idle and Duplicate_U0_ap_idle and CvtColor_U0_ap_idle and CvtColor_1_U0_ap_idle and ConvertScaleAbs_U0_ap_idle and ConvertScaleAbs273_U0_ap_idle and Block_proc_U0_ap_idle and AddWeighted_U0_ap_idle and AXIvideo2Mat_U0_ap_idle);
    ...
    start_for_ConvertScaleAbs273_U0_din <= (0=>ap_const_logic_1, others=>'-');
    start_for_ConvertScaleAbs_U0_din <= (0=>ap_const_logic_1, others=>'-');
