...
const sc_lv<11> Duplicate::ap_const_lv11_438 = "10000111000";
const sc_lv<11> Duplicate::ap_const_lv11_1 = "1";
const sc_lv<11> Duplicate::ap_const_lv11_780 = "11110000000";
...
Duplicate::Duplicate(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( icmp_ln1558_fu_148_p2 );

    SC_METHOD(thread_ap_done);
    sensitive << ( ap_done_reg );
    sensitive << ( icmp_ln1557_fu_136_p2 );
    ...
    SC_METHOD(thread_i_V_fu_142_p2);
    sensitive << ( t_V_reg_114 );

    SC_METHOD(thread_icmp_ln1557_fu_136_p2);
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( t_V_reg_114 );

    SC_METHOD(thread_icmp_ln1558_fu_148_p2);
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( t_V_3_reg_125 );
    sensitive << ( ap_block_pp0_stage0_11001 );
    sensitive << ( ap_enable_reg_pp0_iter0 );
    ...
    sc_trace(mVcdFile, icmp_ln1558_reg_169, "icmp_ln1558_reg_169");
    ...
    sc_trace(mVcdFile, t_V_3_reg_125, "t_V_3_reg_125");
    sc_trace(mVcdFile, icmp_ln1557_fu_136_p2, "icmp_ln1557_fu_136_p2");
    sc_trace(mVcdFile, ap_CS_fsm_state2, "ap_CS_fsm_state2");
    sc_trace(mVcdFile, i_V_fu_142_p2, "i_V_fu_142_p2");
    sc_trace(mVcdFile, i_V_reg_164, "i_V_reg_164");
    sc_trace(mVcdFile, icmp_ln1558_fu_148_p2, "icmp_ln1558_fu_148_p2");
...
void Duplicate::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if (esl_seteq<1,1,1>(ap_const_logic_1, ap_continue.read())) {
            ap_done_reg = ap_const_logic_0;
                    ...
                    esl_seteq<1,1,1>(icmp_ln1557_fu_136_p2.read(), ap_const_lv1_1))) {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
            ...
            ap_enable_reg_pp0_iter0 = ap_const_logic_0;
                    ...
                    esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln1557_fu_136_p2.read()))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
         ...
         esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln1558_fu_148_p2.read()))) {
        t_V_3_reg_125 = j_V_fu_154_p2.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
                esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln1557_fu_136_p2.read()))) {
        t_V_3_reg_125 = ap_const_lv11_0;
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        t_V_reg_114 = i_V_reg_164.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
                !(esl_seteq<1,1,1>(ap_const_logic_0, real_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)))) {
        t_V_reg_114 = ap_const_lv11_0;
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        i_V_reg_164 = i_V_fu_142_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0))) {
        icmp_ln1558_reg_169 = icmp_ln1558_fu_148_p2.read();
    }
}
...
void Duplicate::thread_ap_block_pp0_stage0_01001() {
    ap_block_pp0_stage0_01001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && ((esl_seteq<1,1,1>(icmp_ln1558_reg_169.read(), ap_const_lv1_0) && 
   esl_seteq<1,1,1>(ap_const_logic_0, src_data_stream_V_empty_n.read())) || 
  (esl_seteq<1,1,1>(icmp_ln1558_reg_169.read(), ap_const_lv1_0) && 
...
void Duplicate::thread_ap_block_pp0_stage0_11001() {
    ap_block_pp0_stage0_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && ((esl_seteq<1,1,1>(icmp_ln1558_reg_169.read(), ap_const_lv1_0) && 
   esl_seteq<1,1,1>(ap_const_logic_0, src_data_stream_V_empty_n.read())) || 
  (esl_seteq<1,1,1>(icmp_ln1558_reg_169.read(), ap_const_lv1_0) && 
   esl_seteq<1,1,1>(ap_const_logic_0, dst1_data_stream_V_full_n.read())) || 
  (esl_seteq<1,1,1>(icmp_ln1558_reg_169.read(), ap_const_lv1_0) && 
...
void Duplicate::thread_ap_block_pp0_stage0_subdone() {
    ap_block_pp0_stage0_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && ((esl_seteq<1,1,1>(icmp_ln1558_reg_169.read(), ap_const_lv1_0) && 
   esl_seteq<1,1,1>(ap_const_logic_0, src_data_stream_V_empty_n.read())) || 
  (esl_seteq<1,1,1>(icmp_ln1558_reg_169.read(), ap_const_lv1_0) && 
   esl_seteq<1,1,1>(ap_const_logic_0, dst1_data_stream_V_full_n.read())) || 
  (esl_seteq<1,1,1>(icmp_ln1558_reg_169.read(), ap_const_lv1_0) && 
...
void Duplicate::thread_ap_block_state4_pp0_stage0_iter1() {
    ap_block_state4_pp0_stage0_iter1 = ((esl_seteq<1,1,1>(icmp_ln1558_reg_169.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, src_data_stream_V_empty_n.read())) || (esl_seteq<1,1,1>(icmp_ln1558_reg_169.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, dst1_data_stream_V_full_n.read())) || (esl_seteq<1,1,1>(icmp_ln1558_reg_169.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, dst2_data_stream_V_full_n.read())));
}

void Duplicate::thread_ap_condition_pp0_exit_iter0_state3() {
    if (esl_seteq<1,1,1>(icmp_ln1558_fu_148_p2.read(), ap_const_lv1_1)) {
...
void Duplicate::thread_i_V_fu_142_p2() {
    i_V_fu_142_p2 = (!t_V_reg_114.read().is_01() || !ap_const_lv11_1.is_01())? sc_lv<11>(): (sc_biguint<11>(t_V_reg_114.read()) + sc_biguint<11>(ap_const_lv11_1));
}

void Duplicate::thread_icmp_ln1557_fu_136_p2() {
    icmp_ln1557_fu_136_p2 = (!t_V_reg_114.read().is_01() || !ap_const_lv11_438.is_01())? sc_lv<1>(): sc_lv<1>(t_V_reg_114.read() == ap_const_lv11_438);
}

void Duplicate::thread_icmp_ln1558_fu_148_p2() {
    icmp_ln1558_fu_148_p2 = (!t_V_3_reg_125.read().is_01() || !ap_const_lv11_780.is_01())? sc_lv<1>(): sc_lv<1>(t_V_3_reg_125.read() == ap_const_lv11_780);
}
...
void Duplicate::thread_j_V_fu_154_p2() {
    j_V_fu_154_p2 = (!t_V_3_reg_125.read().is_01() || !ap_const_lv11_1.is_01())? sc_lv<11>(): (sc_biguint<11>(t_V_3_reg_125.read()) + sc_biguint<11>(ap_const_lv11_1));
}
...
void Duplicate::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(icmp_ln1557_fu_136_p2.read(), ap_const_lv1_1))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else {
            ...
            break;
        case 4 : 
            if (!(esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_subdone.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(icmp_ln1558_fu_148_p2.read(), ap_const_lv1_1))) {
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_subdone.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(icmp_ln1558_fu_148_p2.read(), ap_const_lv1_1))) {
