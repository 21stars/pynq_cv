...
struct Block_proc : public sc_module {
    ...
    sc_out< sc_lv<12> > sobel_g_rows_V_out_din;
    sc_in< sc_logic > sobel_g_rows_V_out_full_n;
    sc_out< sc_logic > sobel_g_rows_V_out_write;
    sc_out< sc_lv<12> > sobel_g_cols_V_out_din;
    sc_in< sc_logic > sobel_g_cols_V_out_full_n;
    sc_out< sc_logic > sobel_g_cols_V_out_write;
    ...
    sc_signal< sc_logic > sobel_g_rows_V_out_blk_n;
    sc_signal< sc_logic > sobel_g_cols_V_out_blk_n;
    ...
    void thread_sobel_g_cols_V_out_blk_n();
    void thread_sobel_g_cols_V_out_din();
    void thread_sobel_g_cols_V_out_write();
    void thread_sobel_g_rows_V_out_blk_n();
    void thread_sobel_g_rows_V_out_din();
    void thread_sobel_g_rows_V_out_write();
