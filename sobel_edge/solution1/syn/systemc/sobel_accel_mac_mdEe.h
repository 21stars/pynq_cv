...
// ==============================================================
#ifndef __sobel_accel_mac_mdEe__HH__
#define __sobel_accel_mac_mdEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_accel_mac_mdEe) {
    ...
    SC_CTOR(sobel_accel_mac_mdEe):  simcore_mac_1_U ("simcore_mac_1_U") {
