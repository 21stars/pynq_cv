...
// ==============================================================
#ifndef __sobel_accel_mac_mlbW__HH__
#define __sobel_accel_mac_mlbW__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_accel_mac_mlbW) {
    ...
    SC_CTOR(sobel_accel_mac_mlbW):  simcore_mac_3_U ("simcore_mac_3_U") {
