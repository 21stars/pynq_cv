...
architecture behav of AddWeighted is 
    ...
    signal tmp_51_reg_1107 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal p_Val2_17_fu_659_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_Val2_17_reg_1170 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal p_Val2_14_fu_336_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal p_Result_7_fu_369_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal F2_2_fu_431_p3 : STD_LOGIC_VECTOR (11 downto 0);
    signal p_Val2_s_fu_399_p3 : STD_LOGIC_VECTOR (53 downto 0);
    signal tmp_53_fu_463_p4 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal tmp_54_fu_493_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal p_Val2_15_fu_515_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal qb_fu_547_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln415_fu_563_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_Val2_16_fu_567_p2 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal p_Result_9_fu_555_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal and_ln403_1_fu_627_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal select_ln403_1_fu_633_p3 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal and_ln603_1_fu_679_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal pos1_fu_691_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal pos2_fu_701_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_58_fu_725_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal Range2_V_1_fu_795_p2 : STD_LOGIC_VECTOR (53 downto 0);
    ...
    signal Range1_all_ones_1_fu_759_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln641_fu_833_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal Range1_all_zeros_fu_839_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal Range1_all_zeros_1_fu_857_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal xor_ln639_1_fu_869_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal select_ln642_1_fu_903_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln603_2_fu_685_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln639_fu_895_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln639_1_fu_911_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln654_fu_927_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal p_Result_10_fu_711_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal xor_ln621_fu_939_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln621_2_fu_945_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln557_fu_957_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal empty_109_fu_933_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln621_3_fu_951_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal and_ln428_1_fu_1015_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal or_ln571_2_fu_1036_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_ln571_1_fu_1048_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    component sobel_accel_dadd_sc4 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component sobel_accel_dmul_tde IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component sobel_accel_uitodudo IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    sobel_accel_dadd_sc4_U91 : component sobel_accel_dadd_sc4
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 64,
    ...
    sobel_accel_dadd_sc4_U92 : component sobel_accel_dadd_sc4
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 64,
    ...
    sobel_accel_dmul_tde_U93 : component sobel_accel_dmul_tde
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 64,
    ...
    sobel_accel_dmul_tde_U94 : component sobel_accel_dmul_tde
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 64,
    ...
    sobel_accel_uitodudo_U95 : component sobel_accel_uitodudo
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    sobel_accel_uitodudo_U96 : component sobel_accel_uitodudo
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln355_reg_1093_pp0_iter20_reg = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                ...
                p_Val2_17_reg_1170 <= p_Val2_17_fu_659_p3;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln355_reg_1093 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                tmp_51_reg_1107 <= src2_data_stream_V_dout;
    ...
    Range1_all_ones_1_fu_759_p2 <= (icmp_ln621_fu_719_p2 and and_ln621_fu_753_p2);
    Range1_all_ones_fu_827_p2 <= (select_ln631_fu_813_p3 and Range1_all_ones_1_fu_759_p2);
    Range1_all_zeros_1_fu_857_p2 <= "1" when (p_Val2_s_fu_399_p3 = ap_const_lv54_0) else "0";
    Range1_all_zeros_fu_839_p2 <= (ap_const_lv1_1 xor Range1_all_ones_1_fu_759_p2);
    Range2_V_1_fu_795_p2 <= std_logic_vector(shift_right(unsigned(p_Val2_s_fu_399_p3),to_integer(unsigned('0' & zext_ln635_fu_791_p1(31-1 downto 0)))));
    Range2_all_ones_fu_807_p2 <= "1" when (Range2_V_1_fu_795_p2 = r_V_fu_801_p2) else "0";
    ...
    and_ln403_1_fu_627_p2 <= (xor_ln403_fu_621_p2 and and_ln581_fu_601_p2);
    and_ln403_fu_607_p2 <= (p_Result_9_fu_555_p3 and and_ln581_fu_601_p2);
    and_ln428_1_fu_1015_p2 <= (icmp_ln837_reg_1158 and icmp_ln833_reg_1152);
    and_ln428_fu_983_p2 <= (icmp_ln837_reg_1158 and icmp_ln833_reg_1152);
    and_ln557_fu_957_p2 <= (p_Result_7_fu_369_p3 and icmp_ln621_fu_719_p2);
    ...
    and_ln603_1_fu_679_p2 <= (xor_ln416_fu_581_p2 and or_ln603_fu_673_p2);
    and_ln603_2_fu_685_p2 <= (and_ln603_1_fu_679_p2 and and_ln403_fu_607_p2);
    and_ln603_fu_653_p2 <= (xor_ln581_fu_647_p2 and icmp_ln603_fu_473_p2);
    and_ln621_2_fu_945_p2 <= (xor_ln621_fu_939_p2 and p_Result_10_fu_711_p3);
    and_ln621_3_fu_951_p2 <= (p_Result_7_fu_369_p3 and and_ln621_2_fu_945_p2);
    and_ln621_fu_753_p2 <= (xor_ln621_1_fu_733_p2 and lD_fu_749_p1);
    and_ln631_fu_785_p2 <= (xor_ln631_fu_773_p2 and icmp_ln631_fu_779_p2);
    and_ln639_fu_821_p2 <= (xor_ln621_1_fu_733_p2 and icmp_ln631_fu_779_p2);
    ...
    and_ln654_fu_927_p2 <= (select_ln639_fu_895_p3 and and_ln603_2_fu_685_p2);
    ...
    deleted_zeros_fu_919_p3 <= 
        select_ln639_fu_895_p3 when (and_ln603_2_fu_685_p2(0) = '1') else 
        select_ln639_1_fu_911_p3;
    ...
    empty_109_fu_933_p2 <= (ap_const_lv1_1 xor and_ln654_fu_927_p2);
    ...
    grp_fu_295_p0 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_51_reg_1107),32));
    ...
    icmp_ln585_fu_457_p2 <= "1" when (unsigned(F2_2_fu_431_p3) < unsigned(ap_const_lv12_36)) else "0";
    icmp_ln591_fu_523_p2 <= "1" when (signed(F2_fu_413_p2) > signed(ap_const_lv12_36)) else "0";
    icmp_ln603_fu_473_p2 <= "1" when (tmp_53_fu_463_p4 = ap_const_lv9_0) else "0";
    ...
    icmp_ln641_fu_833_p2 <= "1" when (Range2_V_1_fu_795_p2 = ap_const_lv54_0) else "0";
    ...
    icmp_ln837_fu_359_p2 <= "0" when (tmp_V_3_fu_349_p1 = ap_const_lv52_0) else "1";
    ...
    or_ln571_1_fu_1048_p2 <= (icmp_ln571_reg_1164 or and_ln428_fu_983_p2);
    or_ln571_2_fu_1036_p2 <= (underflow_reg_1176 or or_ln571_fu_1030_p2);
    ...
    or_ln639_fu_875_p2 <= (xor_ln639_1_fu_869_p2 or tmp_58_fu_725_p3);
    or_ln645_fu_863_p2 <= (xor_ln621_1_fu_733_p2 or Range1_all_zeros_1_fu_857_p2);
    or_ln658_1_fu_977_p2 <= (or_ln658_fu_971_p2 or deleted_zeros_fu_919_p3);
    or_ln658_fu_971_p2 <= (xor_ln621_fu_939_p2 or p_Result_7_fu_369_p3);
    p_Result_10_fu_711_p3 <= p_Val2_17_fu_659_p3(7 downto 7);
    p_Result_7_fu_369_p3 <= p_Val2_14_fu_336_p1(63 downto 63);
    p_Result_8_fu_389_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_1_i_fu_381_p3),54));
    p_Result_9_fu_555_p3 <= p_Val2_15_fu_515_p3(7 downto 7);
    ...
    p_Val2_14_fu_336_p1 <= sum_reg_1147;
    p_Val2_15_fu_515_p3 <= 
        trunc_ln586_fu_489_p1 when (icmp_ln585_fu_457_p2(0) = '1') else 
        select_ln588_fu_501_p3;
    p_Val2_16_fu_567_p2 <= std_logic_vector(unsigned(p_Val2_15_fu_515_p3) + unsigned(zext_ln415_fu_563_p1));
    p_Val2_17_fu_659_p3 <= 
        shl_ln604_fu_509_p2 when (and_ln603_fu_653_p2(0) = '1') else 
        select_ln403_1_fu_633_p3;
    p_Val2_s_fu_399_p3 <= 
        man_V_1_fu_393_p2 when (p_Result_7_fu_369_p3(0) = '1') else 
        p_Result_8_fu_389_p1;
    ...
    qb_fu_547_p3 <= 
        p_Result_7_fu_369_p3 when (icmp_ln591_fu_523_p2(0) = '1') else 
    ...
    select_ln340_fu_1008_p3 <= 
        p_Val2_17_reg_1170 when (and_ln340_fu_992_p2(0) = '1') else 
        ap_const_lv8_FF;
    select_ln403_1_fu_633_p3 <= 
        p_Val2_16_fu_567_p2 when (and_ln403_1_fu_627_p2(0) = '1') else 
        select_ln403_fu_613_p3;
    select_ln403_fu_613_p3 <= 
        p_Val2_16_fu_567_p2 when (and_ln403_fu_607_p2(0) = '1') else 
        select_ln582_fu_587_p3;
    select_ln571_fu_1041_p3 <= 
        ap_const_lv8_0 when (or_ln571_2_fu_1036_p2(0) = '1') else 
        p_Val2_17_reg_1170;
    select_ln582_fu_587_p3 <= 
        trunc_ln583_fu_453_p1 when (icmp_ln582_fu_447_p2(0) = '1') else 
        ap_const_lv8_0;
    select_ln588_fu_501_p3 <= 
        ap_const_lv8_FF when (tmp_54_fu_493_p3(0) = '1') else 
        ap_const_lv8_0;
    ...
    select_ln642_1_fu_903_p3 <= 
        ...
        or_ln645_fu_863_p2;
    select_ln642_fu_887_p3 <= 
        Range1_all_ones_1_fu_759_p2 when (and_ln642_fu_881_p2(0) = '1') else 
        xor_ln621_1_fu_733_p2;
        sext_ln581_fu_443_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(F2_2_fu_431_p3),32));
    ...
    tmp_1_i_fu_381_p3 <= (ap_const_lv1_1 & tmp_V_3_fu_349_p1);
    tmp_53_fu_463_p4 <= F2_2_fu_431_p3(11 downto 3);
    tmp_54_fu_493_p3 <= p_Val2_14_fu_336_p1(63 downto 63);
    tmp_56_fu_573_p3 <= p_Val2_16_fu_567_p2(7 downto 7);
    tmp_58_fu_725_p3 <= pos1_fu_691_p2(11 downto 11);
    tmp_59_fu_765_p3 <= pos2_fu_701_p2(11 downto 11);
    tmp_V_3_fu_349_p1 <= p_Val2_14_fu_336_p1(52 - 1 downto 0);
    tmp_V_fu_339_p4 <= p_Val2_14_fu_336_p1(62 downto 52);
    trunc_ln556_fu_365_p1 <= p_Val2_14_fu_336_p1(63 - 1 downto 0);
    trunc_ln581_fu_439_p1 <= F2_2_fu_431_p3(8 - 1 downto 0);
    trunc_ln583_fu_453_p1 <= p_Val2_s_fu_399_p3(8 - 1 downto 0);
    trunc_ln586_fu_489_p1 <= ashr_ln586_fu_483_p2(8 - 1 downto 0);
    underflow_fu_963_p3 <= 
        empty_109_fu_933_p2 when (and_ln557_fu_957_p2(0) = '1') else 
        and_ln621_3_fu_951_p2;
    xor_ln340_1_fu_997_p2 <= (or_ln658_1_reg_1182 xor ap_const_lv1_1);
    xor_ln340_fu_987_p2 <= (underflow_reg_1176 xor ap_const_lv1_1);
    xor_ln403_fu_621_p2 <= (p_Result_9_fu_555_p3 xor ap_const_lv1_1);
    xor_ln416_fu_581_p2 <= (tmp_56_fu_573_p3 xor ap_const_lv1_1);
    xor_ln428_fu_1019_p2 <= (ap_const_lv1_1 xor and_ln428_1_fu_1015_p2);
    xor_ln571_fu_1053_p2 <= (or_ln571_1_fu_1048_p2 xor ap_const_lv1_1);
    ...
    xor_ln621_1_fu_733_p2 <= (tmp_58_fu_725_p3 xor ap_const_lv1_1);
    xor_ln621_fu_939_p2 <= (icmp_ln621_fu_719_p2 xor ap_const_lv1_1);
    xor_ln631_fu_773_p2 <= (tmp_59_fu_765_p3 xor ap_const_lv1_1);
    xor_ln639_1_fu_869_p2 <= (icmp_ln631_fu_779_p2 xor ap_const_lv1_1);
